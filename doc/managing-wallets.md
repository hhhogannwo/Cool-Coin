...
Since version 0.21, CoolCoin no longer has a default wallet.
...
| Windows          | `C:\Users\<user>\AppData\Roaming\CoolCoin\wallets`           |
| macOS            | `/Users/<user>/Library/Application Support/CoolCoin/wallets` |
