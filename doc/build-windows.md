...
Below are some notes on how to build CoolCoin for Windows.

The options known to work for building CoolCoin on Windows are:
...
Note that for WSL the CoolCoin source path MUST be somewhere in the default mount file system, for
