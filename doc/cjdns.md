# CJDNS support in CoolCoin

It is possible to run CoolCoin over CJDNS, an encrypted IPv6 network that
...
done outside of CoolCoin, similarly to a VPN (either in the host/OS or on
...
redundancy and robustness for both the CoolCoin network and individual nodes.
...
before it will work with your CoolCoin node. This is described in steps
...
## Run CoolCoin with CJDNS

Once you are connected to the CJDNS network, the following CoolCoin
...
When enabled, this option tells CoolCoin that it is running in an
...
IPv6 local network. This helps CoolCoin perform better address management:
...
CJDNS support was added to CoolCoin in version 23.0 and there may be fewer
...
[doc/tor.md](https://github.com/hhhogannwo/Cool-Coin/Cool-Coin/blob/master/doc/tor.md) for
details.

## CJDNS-related information in CoolCoin

There are several ways to see your CJDNS address in CoolCoin:
