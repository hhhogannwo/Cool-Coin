# Support for Output Descriptors in CoolCoin

Since CoolCoin v0.17, there is support for Output Descriptors. This is a
...
on CoolCoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
transactions related to the multisig. Lastly, it is not recommended to use anything other than a CoolCoin descriptor wallet to serve as your
...
existing CoolCoin wallets, a convenience function `combo` is
...
All RPCs in CoolCoin will include the checksum in their output. Only
