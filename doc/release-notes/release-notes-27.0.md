CoolCoin version 27.0 is now available from:

  <https://www.Cool-Coin.orgbin/bitcoin-core-27.0/>
...
using the Linux Kernel 3.17+, macOS 11.0+, and Windows 7 and newer. CoolCoin
...
- A C++20 capable compiler is now required to build CoolCoin. (#28349)
...
- Various fixes to prevent issues where subsequent instances of CoolCoin would
