...
CoolCoin version 23.0 is now available from:

  <https://www.Cool-Coin.orgbin/bitcoin-core-23.0/>
...
using the Linux kernel, macOS 10.15+, and Windows 7 and newer.  CoolCoin
...
- Before this release, CoolCoin had a strong preference to try to connect only to peers that listen on port 8333. As a result of that, CoolCoin nodes listening on non-standard ports would likely not get any CoolCoin peers connecting to them. This preference has been removed. (#23542)

- Full support has been added for the CJDNS network. See the new option `-cjdnsreachable` and [doc/cjdns.md](https://github.com/hhhogannwo/Cool-Coin/Cool-Coin/tree/23.x/doc/cjdns.md) (#23077)
...
CoolCoin release binaries for Linux now include experimental tracepoints which
...
[doc/tracing.md](https://github.com/hhhogannwo/Cool-Coin/Cool-Coin/blob/23.x/doc/tracing.md) and
usage examples are provided in [contrib/tracing/](https://github.com/hhhogannwo/Cool-Coin/Cool-Coin/tree/23.x/contrib/tracing).
...
* On startup, the list of banned hosts and networks (via `setban` RPC) in
  `banlist.dat` is ignored and only `banlist.json` is considered. CoolCoin
...
- CLI `-addrinfo` now returns a single field for the number of `onion` addresses
  ...
  for Tor V2 addresses was removed from CoolCoin in 22.0. (#22544)
