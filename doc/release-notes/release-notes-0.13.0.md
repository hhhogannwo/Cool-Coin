CoolCoin version 0.13.0 is now available from:
...
- Adding `dbcache=100` in coolcoin.conf
...
Various code modernizations have been done. The CoolCoin code base has
...
HD wallets are incompatible with older versions of CoolCoin.

[Pull request](https://github.com/hhhogannwo/Cool-Coin/Cool-Coin/pull/8035/files), [BIP 32](https://github.com/bitcoin/bips/blob/master/bip-0032.mediawiki)
...
proposed parameters, a future release of CoolCoin is expected that
...
The two phases are distinct in the CoolCoin-Qt GUI. During the first one,
...
- Each ZMQ notification now contains an up-counting sequence number that allows
  ...
  PR [#7762](https://github.com/hhhogannwo/Cool-Coin/Cool-Coin/pull/7762).
...
- #8207 `f7a403b` Add a link to the CoolCoin-Core repository and website to the About Dialog (MarcoFalke)
...
- #8164 `0f24eaf` [CoolCoin-Tx] fix missing test fixtures, fix 32bit atoi issue (jonasschnelli)
