CoolCoin version *0.15.1* is now available from:

  <https://www.Cool-Coin.orgbin/bitcoin-core-0.15.1/>
...
A number of changes to the way CoolCoin deals with peer connections and invalid blocks
