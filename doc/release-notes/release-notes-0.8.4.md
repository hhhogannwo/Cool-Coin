CoolCoin-Qt version 0.8.4 is now available from:
  http://sourceforge.net/projects/bitcoin/files/CoolCoin/bitcoin-0.8.4/
...
code, causing the CoolCoin-Qt or bitcoind process to crash.
Bloom filters were introduced with version 0.8, so versions 0.8.0
through 0.8.3 are vulnerable to this critical denial-of-service attack.

A constant-time algorithm is now used to check RPC password
guess attempts; fixes https://github.com/hhhogannwo/Cool-Coin/Cool-Coin/issues/2838
(CVE-2013-4165)
...
their own version of CoolCoin against Boost versions 1.50-1.52.
