CoolCoin version 0.13.1 is now available from:
...
In addition to that, with 0.12.x there have been varied reports of CoolCoin
randomly crashing on Windows XP. It is [not clear](https://github.com/hhhogannwo/Cool-Coin/Cool-Coin/issues/7681#issuecomment-217439891)
...
- **Elimination of unwanted transaction malleability:** Segregating the witness
  ...
  malleability, which is a problem that makes programming CoolCoin wallet
  software more difficult and which seriously complicates the design of smart
  contracts for CoolCoin.
...
- **Weighting data based on how it affects node performance:** Some parts of
  each CoolCoin block need to be stored by nodes in order to validate future
...
- **Increased security for multisig:** CoolCoin addresses (both P2PKH addresses
  ...
  believed to be provided by CoolCoin's choice of parameters for its Elliptic
  Curve Digital Security Algorithm [ECDSA].)

- **More efficient almost-full-node security** Satoshi Nakamoto's original
  CoolCoin paper describes a method for allowing newly-started full nodes to
  skip downloading and validating some data from historic blocks that are
  protected by large amounts of proof of work.  Unfortunately, Nakamoto's
  method can't guarantee that a newly-started node using this method will
  produce an accurate copy of CoolCoin's current ledger (called the UTXO set),
  ...
  note that CoolCoin does not provide an option to use this capability as
  of this 0.13.1 release.

- **Script versioning:** Segwit makes it easy for future soft forks to allow
  CoolCoin users to individually opt-in to almost any change in the CoolCoin
  Script language when those users receive new transactions.  Features
  currently being researched by CoolCoin contributors that may use this
  capability include support for Schnorr signatures, which can improve the
  privacy and efficiency of multisig transactions (or transactions with
  multiple inputs), and Merklized Abstract Syntax Trees (MAST), which can
  improve the privacy and efficiency of scripts with two or more conditions.
  Other CoolCoin community members are studying several other improvements
...
[Segwit FAQ]: https://www.Cool-Coin.orgen/2016/01/26/segwit-benefits/
[segwit wallet developers guide]: https://www.Cool-Coin.orgen/segwit_wallet_dev/
[BIP141]: https://github.com/bitcoin/bips/blob/master/bip-0141.mediawiki
[BIP143]: https://github.com/bitcoin/bips/blob/master/bip-0143.mediawiki
[BIP144]: https://github.com/bitcoin/bips/blob/master/bip-0144.mediawiki
[BIP145]: https://github.com/bitcoin/bips/blob/master/bip-0145.mediawiki
[versionbits FAQ]: https://www.Cool-Coin.orgen/2016/06/08/version-bits-miners-faq/
...
Since CoolCoin 0.10.0, nodes have defaulted to only relaying and
