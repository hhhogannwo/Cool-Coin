CoolCoin version *0.15.2* is now available from:

  <https://www.Cool-Coin.orgbin/bitcoin-core-0.15.2/>
...
CoolCoin versions 0.14.0 up to 0.16.2. It is recommended to upgrade any of
