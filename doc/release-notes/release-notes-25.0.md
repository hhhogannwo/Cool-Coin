...
CoolCoin version 25.0 is now available from:

  <https://www.Cool-Coin.orgbin/bitcoin-core-25.0/>
...
- All JSON-RPC methods accept a new [named
  parameter](https://github.com/hhhogannwo/Cool-Coin/Cool-Coin/blob/master/doc/JSON-RPC-interface.md#parameter-passing) called `args` that can
...
dbcache, CoolCoin will now return an error at startup. (#25574)
...
before CoolCoin has begun its shutdown sequence. (#23395)
...
- The binary verification script has been updated. In previous releases it
  ...
  examples, see:
  https://github.com/hhhogannwo/Cool-Coin/Cool-Coin/blob/master/contrib/verify-binaries/README.md
  (#27358)
