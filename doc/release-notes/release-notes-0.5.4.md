CoolCoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/bitcoin/files/CoolCoin/bitcoin-0.5.4/
...
Fix CoolCoin-Qt notifications under Growl 1.3.
Increase required age of CoolCoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxCoolCoin properly when installing CoolCoin-Qt over it. (Windows)
