...
CoolCoin version 0.19.1 is now available from:

  <https://www.Cool-Coin.orgbin/bitcoin-core-0.19.1/>
...
From CoolCoin 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as CoolCoin is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, CoolCoin does not yet change appearance when
