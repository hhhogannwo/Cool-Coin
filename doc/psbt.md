# PSBT Howto for CoolCoin

Since CoolCoin 0.17, an RPC interface exists for Partially Signed CoolCoin
...
PSBT is an interchange format for CoolCoin transactions that are not fully signed
...
#### Multisig with multiple CoolCoin instances
...
CoolCoin. We assume their wallets only contain the multisig funds. In case
