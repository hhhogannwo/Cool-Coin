...
This tutorial will describe how to use two instances of CoolCoin, one online and one offline, to greatly increase security by not having private keys reside on a networked device.
...
This workflow uses [Partially Signed CoolCoin Transactions](https://github.com/hhhogannwo/Cool-Coin/Cool-Coin/blob/master/doc/psbt.md) (PSBTs) to transfer the transaction to and from the offline wallet for signing using the private keys.
...
## Overview
In this tutorial we have two hosts, both running CoolCoin v25.0
