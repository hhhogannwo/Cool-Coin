...
* Update translations see [translation_process.md](https://github.com/hhhogannwo/Cool-Coin/Cool-Coin/blob/master/doc/translation_process.md#synchronising-translations).
* Update release candidate version in `configure.ac` (`CLIENT_VERSION_RC`).
* Update manpages (after rebuilding the binaries), see [gen-manpages.py](https://github.com/hhhogannwo/Cool-Coin/Cool-Coin/blob/master/contrib/devtools/README.md#gen-manpagespy).
* Update coolcoin.conf and commit, see [gen-coolcoin.conf.sh](https://github.com/hhhogannwo/Cool-Coin/Cool-Coin/blob/master/contrib/devtools/README.md#gen-coolcoin.confsh).
...
* On the new release branch in [`configure.ac`](../configure.ac)(see [this commit](https://github.com/hhhogannwo/Cool-Coin/Cool-Coin/commit/742f7dd)):
...
* Update hardcoded [seeds](/contrib/seeds/README.md), see [this pull request](https://github.com/hhhogannwo/Cool-Coin/Cool-Coin/pull/27488) for an example.
* Update the following variables in [`src/kernel/chainparams.cpp`](/src/kernel/chainparams.cpp) for mainnet, testnet, and signet:
  ...
  - `chainTxData` with statistics about the transaction count and rate. Use the output of the `getchaintxstats` RPC with an
    ...
    [this pull request](https://github.com/hhhogannwo/Cool-Coin/Cool-Coin/pull/28591) for an example. Reviewers can verify the results by running
...
- Create a pinned meta-issue for testing the release candidate (see [this issue](https://github.com/hhhogannwo/Cool-Coin/Cool-Coin/issues/27621) for an example) and provide a link to it in the release announcements where useful.
- Translations on Transifex
...
- Ensure the "Needs release note" label is removed from all relevant pull
  requests and issues:
  https://github.com/hhhogannwo/Cool-Coin/Cool-Coin/issues?q=label%3A%22Needs+release+note%22
...
Check out the source code in the following directory hierarchy.
    ...
    git clone https://github.com/hhhogannwo/Cool-Coin/Cool-Coin.git
...
Checkout the CoolCoin version you'd like to build:
...
- Update other repositories and websites for new version
  ...
  - Delete post-EOL [release branches](https://github.com/hhhogannwo/Cool-Coin/Cool-Coin/branches/all) and create a tag `v${branch_name}-final`.

  - Delete ["Needs backport" labels](https://github.com/hhhogannwo/Cool-Coin/Cool-Coin/labels?q=backport) for non-existing branches.
  ...
  - This repo
      ...
      - Create a [new GitHub release](https://github.com/hhhogannwo/Cool-Coin/Cool-Coin/releases/new) with a link to the archived release notes

- Announce the release:

  - bitcoin-dev and bitcoin-core-dev mailing list

  - CoolCoin announcements list https://www.Cool-Coin.orgen/list/announcements/join/

  - CoolCoin Twitter https://twitter.com/bitcoincoreorg
