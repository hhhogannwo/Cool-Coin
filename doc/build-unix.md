UNIX BUILD NOTES
====================
Some notes on how to build CoolCoin in Unix.
...
memory available when compiling CoolCoin. On systems with less, gcc can be
...
To build CoolCoin without wallet, see [*Disable-wallet mode*](#disable-wallet-mode)
...
Disable-wallet mode
--------------------
When the intention is to only run a P2P node, without a wallet, CoolCoin can
