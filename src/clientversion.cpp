...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    // Make sure CoolCoin copyright is not removed by accident
    if (copyright_devs.find("CoolCoin") == std::string::npos) {
        strCopyrightHolders += "\n" + strPrefix + "The CoolCoin developers";
    }
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/hhhogannwo/Cool-Coin/Cool-Coin>";
