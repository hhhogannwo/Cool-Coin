...
The library primarily serves the needs of the CoolCoin project but provides additional functionality for the benefit of the wider CoolCoin ecosystem.
...
* **Relevance Arguments:**
    The relevance of the new functionality for the CoolCoin ecosystem should be argued by outlining clear use cases.
...
The Contributor Workflow & Peer Review in libsecp256k1 are similar to CoolCoin's workflow and review processes described in its [CONTRIBUTING.md](https://github.com/hhhogannwo/Cool-Coin/Cool-Coin/blob/master/CONTRIBUTING.md).
