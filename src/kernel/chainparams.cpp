...
// Copyright (c) 2009-2026 The CoolCoin developers
...
{
    const char* pszTimestamp = "CoolCoin genesis block by MrCool64 July 2026";
...
public:
    CMainParams() {
        ...
        consensus.SegwitHeight = 2147483647; // SegWit disabled for existing Cool Chain
        ...
        genesis = CreateGenesisBlock(1783608520, 1, 0x207fffff, 1, 64 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x563a2580da9e658560b2e40231846683a97e8275274c015ce567e9d4e2dbdc0a"));
        assert(genesis.hashMerkleRoot == uint256S("0xd434abcf20bcad2f047df85e15f9770a0600075e16d67cd76c8a45a02b139b86"));
...
public:
    explicit CRegTestParams(const RegTestOptions& opts)
    {
        ...
        checkpointData = {
            {
                {0, uint256S("563a2580da9e658560b2e40231846683a97e8275274c015ce567e9d4e2dbdc0a")},
            }
        };
