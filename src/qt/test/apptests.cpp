// Copyright (c) 2018-2022 The CoolCoin developers
...
//! Entry point for CoolCoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &CoolCoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for CoolCoinGUI tests.
void AppTests::guiTests(CoolCoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &CoolCoinGUI::consoleShown, this, &AppTests::consoleTests);
