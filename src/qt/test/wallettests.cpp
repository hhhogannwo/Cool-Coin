// Copyright (c) 2015-2022 The CoolCoin developers
                  ...
                  QMessageBox::StandardButton confirm_type = QMessageBox::Yes)
{
    ...
    entry->findChild<CoolCoinAmountField*>("payAmount")->setValue(amount);
...
void CompareBalance(WalletModel& walletModel, CAmount expected_balance, QLabel* balance_label_to_check)
{
    ...
    QString balanceComparison = CoolCoinUnits::formatWithUnit(unit, expected_balance, false, CoolCoinUnits::SeparatorStyle::ALWAYS);
...
void TestGUI(interfaces::Node& node, const std::shared_ptr<CWallet>& wallet)
{
    ...
    // Amount input
    CoolCoinAmountField* amountInput = receiveCoinsDialog.findChild<CoolCoinAmountField*>("reqAmount");
