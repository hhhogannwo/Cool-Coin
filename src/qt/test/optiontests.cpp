...
{
    // Test regression https://github.com/hhhogannwo/Cool-Coin/Cool-Coin/issues/24457. Ensure
...
void OptionTests::parametersInteraction()
{
    ...
    // With fListen=false in ~/.config/CoolCoin/CoolCoin-Qt.conf and all else left as default,
