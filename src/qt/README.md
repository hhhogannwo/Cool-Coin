This directory contains the source code for the CoolCoin graphical user interface (GUI). It uses the [Qt](https://www1.qt.io/developers/) cross-platform framework.
...
- Represents the main window of the CoolCoin UI.
...
* UI elements like CoolCoinAmountField, which inherit from QWidget.
* `bitcoinstrings.cpp`: automatically generated
* `bitcoinunits.(h/cpp)`: CC / mCC / etc. handling
* `callback.h`
...
9. You're all set! Start developing, building, and debugging the CoolCoin GUI
