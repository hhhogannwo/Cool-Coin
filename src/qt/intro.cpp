...
bool Intro::showIfNeeded(bool& did_show_intro, int64_t& prune_MiB)
{
     ...
     * override -datadir in the coolcoin.conf file in the default data directory
...
void Intro::UpdatePruneLabels(bool prune_checked)
{
    ...
    ui->sizeWarningLabel->setText(
        tr("%1 will download and store a copy of the CoolCoin block chain.").arg(PACKAGE_NAME) + " " +
