...
/**
  CoolCoin GUI main class. This class represents the main window of the CoolCoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class CoolCoinGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit CoolCoinGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~CoolCoinGUI();
...
public Q_SLOTS:
    ...
    void incomingTransaction(const QString& date, CoolCoinUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName);
#endif // ENABLE_WALLET
...
public Q_SLOTS:
    ...
    /** Load Partially Signed CoolCoin Transaction from file or clipboard */
...
private Q_SLOTS:
    ...
    void updateDisplayUnit(CoolCoinUnit newUnits);
