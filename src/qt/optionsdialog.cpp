      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->openCoolCoinConfButton->setToolTip(ui->openCoolCoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new CoolCoinUnits(this));
...
void OptionsDialog::setMapper()
{
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSCControls);
...
void OptionsDialog::on_openCoolCoinConfButton_clicked()
{
