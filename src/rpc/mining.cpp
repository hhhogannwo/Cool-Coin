        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    ...
    if (!chainman.GetParams().IsTestChain()) {
        ...
        /* Cool Coin private-network mining:
         * Allow getblocktemplate when no P2P peers are connected.
         * Restore the original check before a public production launch.
         */
...
static RPCHelpMan submitblock()
{
    ...
    return RPCHelpMan{"submitblock",
        ...
        "See https://en.coolcoin.it/wiki/BIP_0022 for full specification.\n",
        {
