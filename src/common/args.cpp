...
const char * const BITCOIN_CONF_FILENAME = "coolcoin.conf";
...
{
    // Windows: C:\Users\Username\AppData\Roaming\CoolCoin
    // macOS: ~/Library/Application Support/CoolCoin
    // Unix-like: ~/.coolcoin
#ifdef WIN32
    // Windows
...
#ifdef MAC_OSX
    // macOS
    return pathRet / "Library/Application Support/CoolCoin";
#else
    // Unix-like
