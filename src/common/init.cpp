// Copyright (c) 2023 The CoolCoin developers
...
std::optional<ConfigError> InitConfig(ArgsManager& args, SettingsAbortFn settings_abort_fn)
{
    try {
        ...
        // coolcoin.conf file just ignores the other file.)
        ...
        if (!fs::exists(base_path)) {
            ...
            // in https://github.com/hhhogannwo/Cool-Coin/Cool-Coin/issues/16220 about ways to
        ...
        // Show an error or warning if there is a coolcoin.conf file in the
