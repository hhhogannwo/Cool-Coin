// Copyright (c) 2012-2022 The CoolCoin developers
...
{
    BOOST_CHECK(TestSplitHost("www.coolcoincore.org", "www.coolcoincore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.coolcoincore.org]", "www.coolcoincore.org", 0));
    BOOST_CHECK(TestSplitHost("www.coolcoincore.org:80", "www.coolcoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.coolcoincore.org]:80", "www.coolcoincore.org", 80));
    ...
    BOOST_CHECK(TestSplitHost("www.coolcoincore.org:65536", "www.coolcoincore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.coolcoincore.org:0", "www.coolcoincore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.coolcoincore.org:", "www.coolcoincore.org:", 0, false));
}
